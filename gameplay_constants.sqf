GRLIB_save_key = "GREUH_LIBERATION_SAVEGAME_UNAMKSE";	// change this value if you want different savegames on different map

GRLIB_sector_size = 1000;
GRLIB_capture_size = 175;
GRLIB_radiotower_size = 4500;
...
GRLIB_battlegroup_cap = 200							* GRLIB_unitcap;
GRLIB_patrol_cap = 120								* GRLIB_unitcap;
GRLIB_battlegroup_size = (random 10)				* GRLIB_unitcap;
